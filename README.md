# Julian Lamprea — Platanus Build Night — Bogotá @ Buk Project
...
- Julian Lamprea ([@jalamprea](https://github.com/jalamprea))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-co-jalamprea.git
